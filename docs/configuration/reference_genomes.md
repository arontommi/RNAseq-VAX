# RNA-seq_AVC: Reference Genomes Configuration

The RNA-seq_AVC pipeline needs a reference genome for alignment and annotation. If not already available, start by downloading the relevant reference, for example from [illumina iGenomes](https://support.illumina.com/sequencing/sequencing_software/igenome.html).
...
```groovy
includeConfig '/path/to/RNA-seq_AVC/conf/igenomes.config'
```
